            ...
            ->columns([
                ...
                TextColumn::make('customer.name')
                    ...
                    ->formatStateUsing(fn (string $state, Order $record): string => view('filament.tables.columns.customer-name', [
                        'name' => $state,
                        'isExpress' => $record->shipping_method === ShippingMethod::Express,
                    ])->render()),
            ...
            ->recordActions([
                ...
                ViewAction::make()
                    ...
                    ->modalContent(fn (Order $record) => view('filament.resources.orders.actions.view-order', [
                        ...
                        'order' => $record->loadMissing(['customer', 'driver', 'items.productSku.product', 'items.services.service', 'payments', 'shipping', 'activities.causer', 'attachments.managedFile']),
                    ])),
